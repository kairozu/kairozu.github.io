...
---
<span class="italics">Note: Kairozu is no longer live, but the source is available here. I've made full database dumps available to the institutions and individuals which were using the flashcard system so they can run their own instances. Thanks everyone for playing with my language-learning system!</span>
